...
echo ""
echo " "
echo "What pdb file would you like to download?"
echo ""
read pdbName
...
if [ $oxidationState -eq 1 ] ; then
      oxid=""
elif [ $oxidationState -eq 2 ] ; then
        oxid="H"
elif [ $oxidationState -eq 3 ] ; then
        oxid="H2"
else
echo "
...
rm ${pdbName}Clean.pdb ${pdbName}_${flavinVariant}${oxid}.xyz.bak
