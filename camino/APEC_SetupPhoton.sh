...
templatedir='/data/PHO_WORK/sajagbe2/QMMM/LOVCalculations/FAD/FADUpdates/camino/Setup'
...
cp /data/PHO_WORK/sajagbe2/QMMM/LOVCalculations/FAD/FADUpdates/camino/New_APEC.sh ${pdbName}_${flavinVariant}${oxid}_APEC_Calculation_Files/
